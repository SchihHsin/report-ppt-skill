...
- `references/components.md` — 唯一选件路由入口 + 组件骨架：胶囊条 / 甘特 / VOC 墙 / 用户旅程 / 竞品对照 / 用户画像三形式 / KPI / glass card / head / 评分热力矩阵 / 分层架构 / 数据突出卡 / 生态干系人地图(§12) / 2×2 机会矩阵(§13) / 图+文 sm2 模式(§14) / 证据矩阵聚光灯(§15) / 四栏推导流(§16)
